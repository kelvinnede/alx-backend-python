#!/usr/bin/env python3
"""
This module contains a function that safely retrieves a value from a dictionary with a default fallback.
"""
...
def safely_get_value(dct: Mapping[Any, T], key: Any, default: Union[T, None] = None) -> Union[T, None]:
    """
    Retrieves the value associated with a key from a dictionary or returns a default value if the key is not found.
